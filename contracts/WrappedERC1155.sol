...
contract Wrapped1155 is Wrapped1155Metadata, ERC20 {
    ...
    constructor() ERC20("Wrapped ERC-1155 Implementation", "WMT*") {}
...
contract Wrapped1155Factory is ERC1155Receiver {
        ...
        returns (bytes4)
    {
        ...
        Wrapped1155 wrapped1155 = getWrapped1155(IERC1155(msg.sender), id, data);
        ...
        returns (bytes4)
    {
        ...
        for (uint i = 0; i < ids.length; i++) {
            ...
            getWrapped1155(IERC1155(msg.sender), ids[i], bytes(data[first:next])).mint(recipient, values[i]);
        }        
        ...
        returns (Wrapped1155)
    {
        ...
        require(wrapped1155Address.isContract(), "Wrapped1155Factory: Wrapped1155 not deployed");
